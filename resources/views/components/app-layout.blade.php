        ...
        <div class="shoping-list flex flex-col gap-8">
            ...
            <div class="bg-rose-800 rounded-lg flex flex-row p-2">
                ...
                <div class="words flex flex-col gap-2">
                    ...
                    <button class="btn bg-white w-3/4 text-black rounded-lg px-4 py-1" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasExample" aria-controls="offcanvasExample"> add item </button>
                    <x-model-form/>
                </div>
            {{-- shopping box end --}}
