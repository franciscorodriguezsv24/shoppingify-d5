...
<div class="finder flex flex-row justify-between ">
    ...
    <div class="relative w-1/4">
        ...
        <input type="text" id="search-navbar" class="block w-full p-2 ps-5 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search...">
    </div>
</div>
{{-- End-searchbar --}}
